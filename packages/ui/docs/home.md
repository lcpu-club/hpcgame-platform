...
比赛的算力环境由[北京大学高性能计算平台](https://hpc.pku.edu.cn)提供。比赛的超算管理平台是北京大学樊春老师团队开发的[SCOW](https://pkuhpc.github.io)，可以在[这里](https://hpc.pku.edu.cn/demo/scow)使用SCOW平台的官方demo。
